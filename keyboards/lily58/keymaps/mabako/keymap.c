...
const key_override_t lbrc_override = ko_make_with_layers_and_negmods(MOD_MASK_CTRL, KC_LBRC, KC_LBRC, ~0, MOD_MASK_SA);
const key_override_t rbrc_override = ko_make_with_layers_and_negmods(MOD_MASK_CTRL, KC_RBRC, KC_RBRC, ~0, MOD_MASK_SA);
